...
# NETWORK MODEL NAME
network_model = 'SR_LFDIFGAN_rgb_3d_L2_ploss_v1'
...
decoders_3D = [
    {
        ...
        'skip_id': ['RGB'],
        'percep_loss': ['Mixed_5b'],# 'block1','block2','block3','block4' 'conv4/conv4_4', 'conv5/conv5_4', 'conv2/conv2_2' ,'conv3/conv3_4','conv4/conv4_4', 'conv1/conv1_2',,'conv3/conv3_4','conv4/conv4_4','conv5/conv5_4' #['block1','block2', 'block3','block4'],
